...
pub fn cpSpatialIndexEach(arg_index: [*c]cpSpatialIndex, arg_func: cpSpatialIndexIteratorFunc, arg_data: ?*c_void) callconv(.C) void {
    var index = arg_index;
    var func = arg_func;
    var data = arg_data;
    index.*.klass.*.each.?(index, func, data);
}
pub fn cpSpatialIndexContains(arg_index: [*c]cpSpatialIndex, arg_obj: ?*c_void, arg_hashid: cpHashValue) callconv(.C) cpBool {
    var index = arg_index;
    var obj = arg_obj;
    var hashid = arg_hashid;
    return index.*.klass.*.contains.?(index, obj, hashid);
}
pub fn cpSpatialIndexInsert(arg_index: [*c]cpSpatialIndex, arg_obj: ?*c_void, arg_hashid: cpHashValue) callconv(.C) void {
    var index = arg_index;
    var obj = arg_obj;
    var hashid = arg_hashid;
    index.*.klass.*.insert.?(index, obj, hashid);
}
pub fn cpSpatialIndexRemove(arg_index: [*c]cpSpatialIndex, arg_obj: ?*c_void, arg_hashid: cpHashValue) callconv(.C) void {
    var index = arg_index;
    var obj = arg_obj;
    var hashid = arg_hashid;
...
pub fn cpSpatialIndexReindexObject(arg_index: [*c]cpSpatialIndex, arg_obj: ?*c_void, arg_hashid: cpHashValue) callconv(.C) void {
    var index = arg_index;
    var obj = arg_obj;
    var hashid = arg_hashid;
    index.*.klass.*.reindexObject.?(index, obj, hashid);
}
pub fn cpSpatialIndexQuery(arg_index: [*c]cpSpatialIndex, arg_obj: ?*c_void, arg_bb: cpBB, arg_func: cpSpatialIndexQueryFunc, arg_data: ?*c_void) callconv(.C) void {
    var index = arg_index;
    var obj = arg_obj;
    var bb = arg_bb;
    var func = arg_func;
...
pub fn cpSpatialIndexSegmentQuery(arg_index: [*c]cpSpatialIndex, arg_obj: ?*c_void, arg_a: cpVect, arg_b: cpVect, arg_t_exit: cpFloat, arg_func: cpSpatialIndexSegmentQueryFunc, arg_data: ?*c_void) callconv(.C) void {
    var index = arg_index;
    var obj = arg_obj;
    var a = arg_a;
    var b = arg_b;
...
pub fn cpSpatialIndexReindexQuery(arg_index: [*c]cpSpatialIndex, arg_func: cpSpatialIndexQueryFunc, arg_data: ?*c_void) callconv(.C) void {
    var index = arg_index;
    var func = arg_func;
    var data = arg_data;
...
pub export fn main() c_int {
    var gravity: cpVect = cpv(@intToFloat(cpFloat, @as(c_int, 0)), @intToFloat(cpFloat, -@as(c_int, 100)));
    var space: ?*cpSpace = cpSpaceNew();
    cpSpaceSetGravity(space, gravity);
    var ground: ?*cpShape = cpSegmentShapeNew(cpSpaceGetStaticBody(space), cpv(@intToFloat(cpFloat, -@as(c_int, 20)), @intToFloat(cpFloat, @as(c_int, 5))), cpv(@intToFloat(cpFloat, @as(c_int, 20)), @intToFloat(cpFloat, -@as(c_int, 5))), @intToFloat(cpFloat, @as(c_int, 0)));
    cpShapeSetFriction(ground, @intToFloat(cpFloat, @as(c_int, 1)));
    _ = cpSpaceAddShape(space, ground);
    var radius: cpFloat = 5;
    var mass: cpFloat = 1;
    var moment: cpFloat = cpMomentForCircle(mass, @intToFloat(cpFloat, @as(c_int, 0)), radius, cpvzero);
    var ballBody: ?*cpBody = cpSpaceAddBody(space, cpBodyNew(mass, moment));
    cpBodySetPosition(ballBody, cpv(@intToFloat(cpFloat, @as(c_int, 0)), @intToFloat(cpFloat, @as(c_int, 15))));
    var ballShape: ?*cpShape = cpSpaceAddShape(space, cpCircleShapeNew(ballBody, radius, cpvzero));
    cpShapeSetFriction(ballShape, 0.7);
    var timeStep: cpFloat = 1.0 / 60.0;
    {
        var time: cpFloat = 0;
        while (time < @intToFloat(f64, @as(c_int, 2))) : (time += timeStep) {
            var pos: cpVect = cpBodyGetPosition(ballBody);
            var vel: cpVect = cpBodyGetVelocity(ballBody);
            _ = printf("Time is %5.2f. ballBody is at (%5.2f, %5.2f). It's velocity is (%5.2f, %5.2f)\n", time, pos.x, pos.y, vel.x, vel.y);
...
pub const __GLIBC_USE = @compileError("unable to translate C expr: unexpected token .HashHash"); // /opt/zig/lib/libc/include/generic-glibc/features.h:179:9
pub const __NTH = @compileError("unable to translate C expr: unexpected token .Identifier"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:57:11
pub const __NTHNL = @compileError("unable to translate C expr: unexpected token .Identifier"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:58:11
pub const __CONCAT = @compileError("unable to translate C expr: unexpected token .HashHash"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:109:9
pub const __STRING = @compileError("unable to translate C expr: unexpected token .Hash"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:110:9
pub const __warnattr = @compileError("unable to translate C expr: unexpected token .Eof"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:144:10
pub const __errordecl = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:145:10
pub const __flexarr = @compileError("unable to translate C expr: unexpected token .LBracket"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:153:10
pub const __REDIRECT = @compileError("unable to translate C expr: unexpected token .Hash"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:184:10
pub const __REDIRECT_NTH = @compileError("unable to translate C expr: unexpected token .Hash"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:191:11
pub const __REDIRECT_NTHNL = @compileError("unable to translate C expr: unexpected token .Hash"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:193:11
pub const __ASMNAME2 = @compileError("unable to translate C expr: unexpected token .Identifier"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:197:10
pub const __attribute_alloc_size__ = @compileError("unable to translate C expr: unexpected token .Eof"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:229:10
pub const __extern_inline = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:356:11
pub const __extern_always_inline = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:357:11
pub const __attribute_copy__ = @compileError("unable to translate C expr: unexpected token .Eof"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:451:10
pub const __LDBL_REDIR2_DECL = @compileError("unable to translate C expr: unexpected token .Eof"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:522:10
pub const __LDBL_REDIR_DECL = @compileError("unable to translate C expr: unexpected token .Eof"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:523:10
pub const __glibc_macro_warning1 = @compileError("unable to translate C expr: unexpected token .Hash"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:537:10
pub const __attr_access = @compileError("unable to translate C expr: unexpected token .Eof"); // /opt/zig/lib/libc/include/generic-glibc/sys/cdefs.h:569:11
pub const va_start = @compileError("TODO implement function '__builtin_va_start' in std.zig.c_builtins"); // /opt/zig/lib/include/stdarg.h:17:9
pub const va_end = @compileError("TODO implement function '__builtin_va_end' in std.zig.c_builtins"); // /opt/zig/lib/include/stdarg.h:18:9
pub const va_arg = @compileError("TODO implement function '__builtin_va_arg' in std.zig.c_builtins"); // /opt/zig/lib/include/stdarg.h:19:9
pub const __va_copy = @compileError("TODO implement function '__builtin_va_copy' in std.zig.c_builtins"); // /opt/zig/lib/include/stdarg.h:24:9
pub const va_copy = @compileError("TODO implement function '__builtin_va_copy' in std.zig.c_builtins"); // /opt/zig/lib/include/stdarg.h:27:9
pub const __STD_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // /opt/zig/lib/libc/include/generic-glibc/bits/types.h:137:10
pub const __FSID_T_TYPE = @compileError("unable to translate C expr: expected Identifier instead got: LBrace"); // /opt/zig/lib/libc/include/x86_64-linux-gnu/bits/typesizes.h:73:9
pub const __getc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /opt/zig/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:102:9
pub const __putc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /opt/zig/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:106:9
pub const __f32 = @compileError("unable to translate C expr: unexpected token .HashHash"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:91:12
pub const __f64x = @compileError("unable to translate C expr: unexpected token .HashHash"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:120:13
pub const __CFLOAT32 = @compileError("unable to translate: TODO _Complex"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:149:12
pub const __CFLOAT64 = @compileError("unable to translate: TODO _Complex"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:160:13
pub const __CFLOAT32X = @compileError("unable to translate: TODO _Complex"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:169:12
pub const __CFLOAT64X = @compileError("unable to translate: TODO _Complex"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:178:13
pub const __builtin_nansf32 = @compileError("TODO implement function '__builtin_nansf' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:221:12
pub const __builtin_huge_valf64 = @compileError("TODO implement function '__builtin_huge_val' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:255:13
pub const __builtin_inff64 = @compileError("TODO implement function '__builtin_inf' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:256:13
pub const __builtin_nanf64 = @compileError("TODO implement function '__builtin_nan' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:257:13
pub const __builtin_nansf64 = @compileError("TODO implement function '__builtin_nans' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:258:13
pub const __builtin_huge_valf32x = @compileError("TODO implement function '__builtin_huge_val' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:272:12
pub const __builtin_inff32x = @compileError("TODO implement function '__builtin_inf' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:273:12
pub const __builtin_nanf32x = @compileError("TODO implement function '__builtin_nan' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:274:12
pub const __builtin_nansf32x = @compileError("TODO implement function '__builtin_nans' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:275:12
pub const __builtin_huge_valf64x = @compileError("TODO implement function '__builtin_huge_vall' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:289:13
pub const __builtin_inff64x = @compileError("TODO implement function '__builtin_infl' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:290:13
pub const __builtin_nanf64x = @compileError("TODO implement function '__builtin_nanl' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:291:13
pub const __builtin_nansf64x = @compileError("TODO implement function '__builtin_nansl' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:292:13
pub const __FD_ZERO = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // /opt/zig/lib/libc/include/generic-glibc/bits/select.h:25:9
pub const __FD_SET = @compileError("unable to translate C expr: expected ')' instead got: PipeEqual"); // /opt/zig/lib/libc/include/generic-glibc/bits/select.h:32:9
pub const __FD_CLR = @compileError("unable to translate C expr: expected ')' instead got: AmpersandEqual"); // /opt/zig/lib/libc/include/generic-glibc/bits/select.h:34:9
pub const __PTHREAD_MUTEX_INITIALIZER = @compileError("unable to translate C expr: unexpected token .LBrace"); // /opt/zig/lib/libc/include/x86_64-linux-gnu/bits/struct_mutex.h:56:10
pub const __PTHREAD_RWLOCK_ELISION_EXTRA = @compileError("unable to translate C expr: unexpected token .LBrace"); // /opt/zig/lib/libc/include/x86_64-linux-gnu/bits/struct_rwlock.h:40:11
pub const __ONCE_FLAG_INIT = @compileError("unable to translate C expr: unexpected token .LBrace"); // /opt/zig/lib/libc/include/generic-glibc/bits/thread-shared-types.h:127:9
pub const HUGE_VAL = @compileError("TODO implement function '__builtin_huge_val' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/math.h:48:10
pub const HUGE_VALL = @compileError("TODO implement function '__builtin_huge_vall' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/math.h:60:11
pub const __MATHCALL_VEC = @compileError("unable to translate C expr: unexpected token .Identifier"); // /opt/zig/lib/libc/include/generic-glibc/math.h:264:9
pub const __MATHDECL_VEC = @compileError("unable to translate C expr: unexpected token .Identifier"); // /opt/zig/lib/libc/include/generic-glibc/math.h:268:9
pub const __MATHDECL = @compileError("unable to translate C expr: unexpected token .Semicolon"); // /opt/zig/lib/libc/include/generic-glibc/math.h:274:9
pub const __MATHDECLX = @compileError("unable to translate C expr: unexpected token .Identifier"); // /opt/zig/lib/libc/include/generic-glibc/math.h:279:9
pub const __MATHDECL_1_IMPL = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /opt/zig/lib/libc/include/generic-glibc/math.h:282:9
pub const __MATHREDIR = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /opt/zig/lib/libc/include/generic-glibc/math.h:291:9
pub const __MATHCALL_NARROW_NORMAL = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /opt/zig/lib/libc/include/generic-glibc/math.h:539:9
pub const __MATHCALL_NARROW_REDIR = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /opt/zig/lib/libc/include/generic-glibc/math.h:541:9
pub const __MATH_TG = @compileError("unable to translate C expr: expected ':'"); // /opt/zig/lib/libc/include/generic-glibc/math.h:902:10
pub const fpclassify = @compileError("TODO implement function '__builtin_fpclassify' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/math.h:947:11
pub const isfinite = @compileError("TODO implement function '__builtin_isfinite' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/math.h:974:11
pub const isnormal = @compileError("TODO implement function '__builtin_isnormal' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/math.h:982:11
pub const isgreater = @compileError("TODO implement function '__builtin_isgreater' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/math.h:1268:11
pub const isgreaterequal = @compileError("TODO implement function '__builtin_isgreaterequal' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/math.h:1269:11
pub const isless = @compileError("TODO implement function '__builtin_isless' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/math.h:1270:11
pub const islessequal = @compileError("TODO implement function '__builtin_islessequal' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/math.h:1271:11
pub const islessgreater = @compileError("TODO implement function '__builtin_islessgreater' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/math.h:1272:11
pub const isunordered = @compileError("TODO implement function '__builtin_isunordered' in std.zig.c_builtins"); // /opt/zig/lib/libc/include/generic-glibc/math.h:1273:11
pub const cpAssertSoft = @compileError("unable to translate C expr: expected ')'"); // /usr/include/chipmunk/chipmunk.h:53:10
pub const cpAssertWarn = @compileError("unable to translate C expr: expected ')'"); // /usr/include/chipmunk/chipmunk.h:54:10
pub const cpAssertHard = @compileError("unable to translate C expr: expected ')'"); // /usr/include/chipmunk/chipmunk.h:58:9
pub const __INT64_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /opt/zig/lib/libc/include/generic-glibc/stdint.h:106:11
pub const __UINT64_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /opt/zig/lib/libc/include/generic-glibc/stdint.h:107:11
pub const INT64_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /opt/zig/lib/libc/include/generic-glibc/stdint.h:252:11
pub const UINT32_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /opt/zig/lib/libc/include/generic-glibc/stdint.h:260:10
pub const UINT64_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /opt/zig/lib/libc/include/generic-glibc/stdint.h:262:11
pub const INTMAX_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /opt/zig/lib/libc/include/generic-glibc/stdint.h:269:11
pub const UINTMAX_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /opt/zig/lib/libc/include/generic-glibc/stdint.h:270:11
pub const FLT_ROUNDS = @compileError("TODO implement function '__builtin_flt_rounds' in std.zig.c_builtins"); // /opt/zig/lib/include/float.h:83:9
pub const CP_ARBITER_GET_SHAPES = @compileError("unable to translate C expr: unexpected token .Semicolon"); // /usr/include/chipmunk/cpArbiter.h:70:9
pub const CP_ARBITER_GET_BODIES = @compileError("unable to translate C expr: unexpected token .Semicolon"); // /usr/include/chipmunk/cpArbiter.h:78:9
pub const CP_CONVEX_HULL = @compileError("unable to translate C expr: unexpected token .Equal"); // /usr/include/chipmunk/chipmunk.h:177:9
